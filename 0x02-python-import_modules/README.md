...
9. 103-fast_alphabet.py:  a program that prints the alphabet in uppercase, followed by a new line.
    ...
    You are not allowed to use:
        ...
        any string literal
        any system calls
NB: Here i used a buitin module, string.

10. 102-magic_calculation.py: Python function def magic_calculation(a, b): that does exactly the same as the following Python bytecode:
